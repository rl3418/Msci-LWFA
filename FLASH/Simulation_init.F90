...
#include "Flash.h"
  ...
  call RuntimeParameters_get('sim_yeTarg', sim_yeTarg)
  call RuntimeParameters_get('sim_yeCham', sim_yeCham)
  ...
  call RuntimeParameters_get('peak_rho', peak_rho)
  call RuntimeParameters_get('FWHM', FWHM)
